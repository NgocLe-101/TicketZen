$(document).ready(function () {
  ...
  const loadingHtml = `
        <div id="spinner" class="show w-100 h-100 d-flex align-items-center justify-content-center">
        ...
        .done(function (response) {
          setTimeout(() => {
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="${0.1 + index * 0.2}s">
                    <div class="product-item">
                        ...
                        <div class="text-center p-4">
                            <a class="h5 text-clamp-1 mb-2" href="/movies/${movie.id}">${movie.title}</a>
                        ...
                        <div class="d-flex border-top">
                            ...
                            <small class="w-50 text-center py-2">
                                <a class="text-body add-cart-item" href="javascript:void(0)" data-id="${movie.id}"><i class="fa fa-shopping-bag text-primary me-2"></i>Add to cart</a>
                            </small>
                        </div>
                    </div>
                </div>
            ...
            $(".add-cart-item").click(function (e) {
              ...
              window.location.href = `/showtimes/${movieId}`;
            });
          }, 1);
        })
        .fail(function () {
